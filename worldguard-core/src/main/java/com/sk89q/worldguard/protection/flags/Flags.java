...
public final class Flags {
    ...
    /** When true, players with worldguard.visualize running the configured Visualize command on enter (with cooldown). */
    public static final BooleanFlag VISUALIZE = register(new BooleanFlag("visualize"));
    ...
    /** When true, play the configured deny sound to players with worldguard.sound when an action is denied (respects cooldown). */
    public static final BooleanFlag DENY_SOUND = register(new BooleanFlag("deny-sound"));
