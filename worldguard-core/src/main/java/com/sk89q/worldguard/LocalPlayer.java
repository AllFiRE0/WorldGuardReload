...
public interface LocalPlayer extends Player, RegionAssociable {
    ...
    /**
     * Send a protection deny message. Display channel (chat, action bar, or title) is determined by platform configuration.
     */
    default void sendProtectionMessage(String message) {
        printRaw(message);
    }
}
